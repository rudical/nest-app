...
export class WidgetService {
  ...
  constructor() {
    const w1: Widget = new Widget('small', `Annual Retirement Income`, 1, 27);
    w1.handsetCol = 2;
    w1.handsetRow = 27;
    ...
    const w2 = new Widget('small', `Estate Value`, 1, 27);
    w2.handsetCol = 2;
    w2.handsetRow = 27;
    ...
    const w3 = new Widget('action-plan', `Action Plan`, 2, 60);
    w3.handsetCol = 2;
    w3.handsetRow = 60;
